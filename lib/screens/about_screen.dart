                ...
                GlassCard(
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildBullet('启用宏插件后，需授予悬浮窗与辅助功能权限'),
                      _buildBullet('单击悬浮球执行当前启用的宏'),
                      _buildBullet('执行循环宏时，快速多次点击悬浮球可停止'),
                ...
                GlassCard(
                  child: Column(
                    ...
                    children: [
                      _buildTitle('权限说明'),
                      const SizedBox(height: 10),
                      _buildBullet('悬浮窗权限：显示悬浮球、气泡与键盘'),
                      _buildBullet('辅助功能权限：录制点击、回放宏、识别屏幕颜色、查找输入框并注入文字'),
